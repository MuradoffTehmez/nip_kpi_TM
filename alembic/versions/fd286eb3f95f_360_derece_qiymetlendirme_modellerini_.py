...
def upgrade() -> None:
    ...
    # degree360_sessions cədvəlini yarat
    ...
    # degree360_questions cədvəlini yarat
    ...
    # degree360_participants cədvəlini yarat
    ...
    # degree360_answers cədvəlini yarat
